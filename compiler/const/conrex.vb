...
Public Class conrex
    ...
    Public Shared plvbcommondatatype() As String = {"Boolean", "Int8", "Int16", "Int32", "Int64", "Decimal", "UInt8", "UInt16", "UInt32", "UInt64", conrex.STRING, "Char", "Single", "Double", "Object"}
    Public Shared msilcommondatatype() As String = {"bool", "int8", "int16", "int32", "int64", "decimal", "uint8", "uint16", "uint32", "uint64", conrex.STRING, "char", "float32", "float64", "object"}
    ...
    Public Shared DOTNETCACHEDIR As String = CACHEDIR & "\.NetCoreCache"
    Public Shared STDPATH As String = APPDIR & "\std\"
    ...
    Public Const STBLOCK As Char = "{"
    Public Const ENBLOCK As Char = "}"
