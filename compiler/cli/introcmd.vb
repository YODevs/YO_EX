...
Public Class introcmd
    ...
    Public Shared Sub show_intro()
        If Console.CursorTop > 20 Then
            Console.Clear()
        End If
        Console.Write(constcli.helpheader)
    ...
    Private Shared Sub proc_intro(result As String)
        Dim getintro As String = File.ReadAllText(conrex.APPDIR & "\iniopt\intro.yoda")
        Dim yodaf As New YODA_Format
        ...
        Else
            dserr.new_error(conserr.errortype.RUNTIMEERROR, -1, Nothing, "No help for '" & result & "' command found.")
        End If
    End Sub
