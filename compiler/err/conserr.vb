...
You can reinstall the software or email us.")
        set_new_error(errortype.DECLARINGERROR, errorpriority.STOP, "Declaring error", "This local variable is already declared in the current block Or fields.")
        ...
        set_new_error(errortype.EVENTERROR, errorpriority.STOP, "Event error", "{0}")
    End Sub
End Class
