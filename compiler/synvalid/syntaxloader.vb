...
...
    ...
    Private Shared Sub st_break()
        ...
        add_token(exptokenslist, tokenhared.token.UL, tokenhared.token.IF, tokenhared.token.TO, tokenhared.token.LOOP, tokenhared.token.TRY, tokenhared.token.WHILE, tokenhared.token.MATCH, tokenhared.token.FOR)
